...
// 초기 구현에서 Generation 노드를 만들지 않더라도, 나중에 사용하기 쉽도록 규칙만 미리 둘 수 있다.
...
// 같은 포켓몬이라도 기술, 특성, 아이템이 다를 수 있으므로 Pokemon과 별도로 관리한다.
...
// 팀 이름 검색용 인덱스
// 사용자가 저장한 팀을 이름으로 찾는 기능을 만들 때 사용한다.
