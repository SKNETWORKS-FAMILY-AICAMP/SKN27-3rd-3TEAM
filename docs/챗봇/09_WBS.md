...
gantt
    ...
    section Phase 2: 기본 검색 엔진 개발
        PGVector 임베딩 파이프라인     :done,    p2-1, 2025-05-14, 4d
        Neo4j 그래프 로더 개발         :done,    p2-2, 2025-05-14, 4d
        search_pokemon_db Tool        :done,    p2-3, 2025-05-18, 3d
        search_flavor_text (벡터만)    :done,    p2-4, 2025-05-21, 2d
        Neo4j Tool 3종 개발            :done,    p2-5, 2025-05-23, 5d
        기본 LangGraph Agent 구성      :done,    p2-6, 2025-05-28, 4d

    section Phase 3: 고도화 (Hybrid Search + CRAG)
        BM25 인덱스 빌드 및 통합       :active,  p3-1, 2025-06-01, 3d
        pg_trgm 검색 통합              :active,  p3-2, 2025-06-04, 2d
        RRF 결합 및 search_flavor_text 리팩터 :active, p3-3, 2025-06-06, 3d
        Query Rewriting 구현          :         p3-4, 2025-06-09, 2d
        CRAG 노드 구현                :         p3-5, 2025-06-11, 3d
        KNOWN_EVO_CONDITIONS fallback :         p3-6, 2025-06-14, 2d
        동점 처리 SQL 패턴 검증        :         p3-7, 2025-06-16, 2d
        System Prompt v1.2 개정       :         p3-8, 2025-06-18, 2d

    section Phase 4: API 및 UI 통합
        FastAPI 서버 구현              :         p4-1, 2025-06-20, 4d
        Agent ↔ API 통합 테스트        :         p4-2, 2025-06-24, 3d
        채팅 UI 개발                   :         p4-3, 2025-06-27, 5d
        E2E 통합 테스트                :         p4-4, 2025-07-02, 3d
