...
<style>
    ...
    .stApp {
        ...
        /* Optional: Add a subtle background pattern image here if available */
    ...
    .detail-nav {
        ...
        align-items: center;
        margin-top: -60px; /* Counteract Streamlit's default padding */
        margin-left: -50px;
        margin-right: -50px;
        margin-bottom: 40px;
    }
    ...
    /* The white card has a small fold/cut at top-left in the mockup, but rounded is fine */
...
# Mock missing data from DB for the UI completeness
classification = "씨앗포켓몬" # Mock
gender_ratio = "♂ 87.5% ♀ 12.5%" # Mock
...
abilities_str = ", ".join(abilities_list) if abilities_list else "심록" # Fallback mock
...
if evo_chain:
    ...
    for i, evo in enumerate(evo_chain):
        ...
        evo_html += f'''
        <a href="?id={e_id}" target="_self" style="text-decoration:none; color:inherit;">
            <div class="evo-card">
