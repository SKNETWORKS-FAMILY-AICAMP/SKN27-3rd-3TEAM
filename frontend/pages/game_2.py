...
with col_main:
    ...
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    #vcard{{background:rgba(30,30,30,0.9);border:2px solid #BC66FF;border-radius:30px;
      padding:40px;text-align:center;max-width:400px;width:90%;
      box-shadow:0 0 100px rgba(188,102,255,0.3);animation:pop .6s cubic-bezier(.34,1.56,.64,1)}}
    @keyframes pop{{from{{transform:scale(.7);opacity:0}}to{{transform:scale(1);opacity:1}}}}
    #vcard h2{{font-size:2.5rem;font-weight:900;color:#fff;margin-bottom:15px}}
    .vstats{{color:#ccc;font-size:1rem;margin:15px 0 25px;line-height:2.2}}
    .vstats span{{color:#BC66FF;font-weight:900;font-size:1.2rem}}
    #play-again{{padding:14px 45px;background:#BC66FF;
      color:#fff;border:none;border-radius:50px;font-size:1.1rem;font-weight:900;
      cursor:pointer;transition:all .3s;box-shadow:0 10px 30px rgba(188,102,255,0.4)}}
    #play-again:hover{{transform:scale(1.05);box-shadow:0 15px 40px rgba(188,102,255,0.6)}}
    </style></head>
    <body>
    <div id="wrap">
      <div id="diff-bar">
