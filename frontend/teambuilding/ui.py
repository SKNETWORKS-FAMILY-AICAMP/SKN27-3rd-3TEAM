...
_LOAD_MORE_CSS = """
<style>
    .team-load-more-marker + div[data-testid="stButton"] { display: none !important; }
    .team-infinite-loader {
        display: flex; flex-direction: column; align-items: center;
        padding: 20px 0; gap: 8px; color: #888; font-size: 0.85rem;
    }
    .pokeball-loader {
...
<div class="team-infinite-loader"><div class="pokeball-loader"></div><span>목록을 더 불러오고 있어요...</span></div>
"""
...
<script>
    function findAndClick() {
        ...
        for (const btn of buttons) {
            if (btn.textContent.includes("더 보기")) { btn.click(); return true; }
        }
        return false;
    }
        ...
        with st.container(height=580, border=False):
            ...
            if len(filtered_pokemon) > limit:
                ...
                if st.button("더 보기", key="team_btn_load_more"):
                    ...
                    st.rerun()
                stcv1.html(_INFINITE_SCROLL_JS, height=0)
