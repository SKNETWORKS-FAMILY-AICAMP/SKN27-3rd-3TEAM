...
def show():
    ...
    KANTO_BADGES = [
        {"file": "회색배지.png",   "name": "하드코딩 배지",  "gym": "웅이 · 하드코딩",    "mission": "트레이너 등록",   "desc": "마이페이지 방문",                      "glow": "#a0aec0", "unlocked": True},
        {"file": "블루배지.png",   "name": "스트리밍 배지",  "gym": "이슬이 · 스트리밍", "mission": "퀴즈 첫 도전",    "desc": f"실루엣 퀴즈 1회+  ({s_total}회)",      "glow": "#63b3ed", "unlocked": s_total >= 1},
        {"file": "골드배지.png",   "name": "번아웃 배지",    "gym": "순무 · 번아웃",      "mission": "베테랑 퀴즈러",   "desc": f"퀴즈 정답 5회+  ({s_correct}회)",      "glow": "#fc8181", "unlocked": s_correct >= 5},
        {"file": "무지개배지.png", "name": "브랜치 배지",    "gym": "민화 · 브랜치",      "mission": "도감 컬렉터",     "desc": f"포켓몬 10마리 수집  ({len(_collected_ids)}마리)", "glow": "#68d391", "unlocked": len(_collected_ids) >= 10},
        {"file": "핑크배지.png",   "name": "서버리스 배지",  "gym": "풍란 · 서버리스",    "mission": "팀 분석가",       "desc": f"팀 분석 1회 진행  ({len(team_history)}회)",      "glow": "#4fd1c5", "unlocked": len(team_history) >= 1},
        {"file": "진홍색배지.png", "name": "런타임 배지",    "gym": "채두 · 런타임",      "mission": "오박사와 대화",   "desc": f"오박사님과 대화 1회+  ({len(chat_sessions)}회)",  "glow": "#f6ad55", "unlocked": len(chat_sessions) >= 1},
        {"file": "오렌지배지.png", "name": "파라미터 배지",  "gym": "아이리스 · 파라미터", "mission": "배틀 도전자",     "desc": f"배틀 참여 1회+  ({b_total}회)",         "glow": "#9f7aea", "unlocked": b_total >= 1},
        {"file": "그린배지.png",   "name": "오리진 배지",    "gym": "지우 · 오리진",      "mission": "챔피언 도전자",   "desc": f"트레이너 Lv.10+  (Lv.{level})",        "glow": "#FFCB05", "unlocked": level >= 10},
    ]
